...
// 1. Yaşı 36 ilə 46 arasında olan borcluları göstərin
// 2. Borcu 5000-dən çox olmayan borcluları göstərin
// 3. Adı 'A' hərfi ilə başlayan borcluları göstərin
// 4. Qışda doğulan borcluları göstərin﻿


#region Task 1

//var result = from i in debtors
//             where DateTime.Now.Year - i.BirthDay.Year >= 36 && DateTime.Now.Year - i.BirthDay.Year <= 46
//             select new
//             {
//                 Name = i.FullName,
//                 Bday = i.BirthDay,
...
//{
//    int age = DateTime.Now.Year - debtor.Bday.Year;
//    Console.WriteLine($"{debtor.Name}, {age} - {debtor.Dept} AZN");
//}
...
//foreach (var debtor in result)
//{
//    Console.WriteLine($"{debtor.Name} - {debtor.Dept} AZN");
//}
...
var result = from i in debtors
             where i.BirthDay.Month == 12 || i.BirthDay.Month == 1 || i.BirthDay.Month == 2
             select new
             {
                 Name = i.FullName,
                 Bday = i.BirthDay,
...
foreach (var debtor in result)
{
    Console.WriteLine($"{debtor.Name}, {debtor.Bday.ToString("dd.MM.yyyy")} - {debtor.Dept} AZN");
}
